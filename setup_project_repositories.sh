...
# 🚀 Portfolio Projects Repository Setup Script
# This script creates 8 separate GitHub repositories for your portfolio projects

echo "🚀 Setting up 8 Portfolio Project Repositories..."
echo "=================================================="

# Base directory for all projects
BASE_DIR="../portfolio-projects"
mkdir -p $BASE_DIR

# Project configurations
declare -A projects=(
    ["trust-safety-analytics"]="Trust & Safety Analytics Project - Fraud detection and platform security"
...
for project in "${!projects[@]}"; do
    create_project "$project" "${projects[$project]}"
done

echo "🎉 All 8 project repositories created successfully!"
echo ""
echo "📋 Next Steps:"
echo "1. Create GitHub repositories for each project"
echo "2. Add remote origins to each local repository"
echo "3. Push code to GitHub"
echo "4. Update portfolio links to point to individual repositories"
echo ""
...
echo ""
echo "📁 All projects are located in: $BASE_DIR"
